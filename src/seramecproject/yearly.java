 ...
 * @author m7med nasser
 */
public class yearly extends javax.swing.JInternalFrame {
 ...
 public void select_Cheek(){
        try
        {
            ...
            Statement stmt=conn.createStatement();
             String query="SELECT * FROM payment where  year ="+cmbYears.getSelectedItem();         
  ...
  public void select_masrof(){
        try
        {
            Class.forName(Driver);
             conn= DriverManager.getConnection(DatabaseUrl,USER,PASS);
            Statement stmt=conn.createStatement();
            String query="SELECT * FROM masrof where year ="+cmbYears.getSelectedItem();               
